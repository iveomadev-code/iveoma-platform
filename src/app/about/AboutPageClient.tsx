      ...
      <section style={{ backgroundColor: '#FFFFFF' }} className="section-pad milestones-section">
        <div className="container">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-80px" }} transition={entranceSpring}>
            ...
            <h2 style={{ fontFamily: 'var(--font-heading-monumental), var(--font-heading), serif', fontSize: 'clamp(34px, 4.5vw, 56px)', fontWeight: 700, color: 'var(--primary)', lineHeight: 1.05, letterSpacing: '-0.02em', maxWidth: '680px', margin: 0 }}>Nine years. Nine interventions. All still standing.</h2>
                  ...
                  <div style={{ position: 'relative', maxWidth: '900px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                      {[
                        ...
                        { year: "2021", title: "The Iveoma Annual Health Walk", body: "Launched a recurring community wellness initiative in Okposi, lacing up every December to promote physical fitness, preventive health awareness, and diaspora bonding.", media: "Photo needed: Health walk, 2021" },
                        ...
                        { year: "2024", title: "Cultural Integration & Peace-Building", body: "Partnered with paramount traditional rulers in Okposi to support cultural heritage festivals, promoting social cohesion and alignment of development goals with traditional institutions.", media: "Photo needed: Cultural festival, 2024" },
                        { year: "2025", title: "Excellent Hope Hospital & Maternity Support", body: "Equipped the local clinic with a 36kg medical oxygen cylinder donation to build respiratory emergency resilience and local capacity.", media: "Photo needed: Oxygen Cylinder donation, 2025" },
